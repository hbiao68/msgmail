		...
		<table style="padding-bottom: 10px" width="100%" cellspacing="0"
			...
			<tbody>
				...
				<tr class="normal black">
					<td align="right"><div
							style="width: 120px; white-space: nowrap; text-align: right;">用户名：</div></td>
					<td width="96%" align="left">${username }&nbsp;</td>
				</tr>
			...
			<tbody>
				<div style="" class="list_btline">
					<div class="f_size selbar_bt barspace2"
						...
						align="center">
						<input type="submit" title="返回" name="next" value="返回" class="button">
					</div>
				</div>
			</tbody>
		</table>
