...
<body>
	<form action="<%=request.getContextPath()%>/login/insertAction.do"
			...
			<tbody align="center">
				...
				<tr class="normal black">
					<td align="right"><div
							...
							用户名：</div></td>
					<td width="55%" align="left"><input id="userName" type="text"
			...
			<tbody>
				<div style="" class="list_btline">
					<div class="f_size selbar_bt barspace2"
						...
						align="center">
						<input type="submit" title="注册" name="next" value="注册" class="add button">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" title="返回" name="next" value="返回" class="button" onclick="return onLogin()">
					</div>
				</div>
			</tbody>
		</table>
