...
<body onload="init()">
	<form action="<%=request.getContextPath()%>/user/updatePwdAction.do"
			...
			<tbody>
				...
				<tr class="normal black">
					<td align="right"><div
							...
							现在的密码：</div></td>
					<td width="96%" align="left"><input id="CurrentUserPassword" type="password"
					    size="28" class="txt noime" 
						name="CurrentUserPassword" maxlength="30" required onchange="checkCurrentUserName()">&nbsp;<font
				...
				<tr class="normal black">
					...
					<td align="left">
						<input type="password" name="NewUserPassword" id="mypassword" maxlength="32" size="28"  class="txt noime" required autocomplete="off">&nbsp;<font color="red">*</font>
					</td>
				</tr>
				...
				<tr class="normal black">
					...
					<td align="left">
						<input type="password" name="NewReuserPassword" id="reuserPassword" equalTo="#mypassword" maxlength="32" size="28"  class="txt noime" required autocomplete="off">&nbsp;<font color="red">*</font>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				<div style="" class="list_btline">
					<div class="f_size selbar_bt barspace2"
						...
						<input type="button" name="next" title="返回" value="返回" class="button" onclick="return onReturn('${userid }')">
					</div>
				</div>
			</tbody>
		</table>
...
<script type="text/javascript">
	...
	function checkCurrentUserName(){
		$.ajax({
			type : "POST",
			url : "/myspring/user/checkCurrentUserName.do",
			dataType : "json",
			data:{"CurrentUserPassword":$("#CurrentUserPassword").val(),"uid":$("#uid").val()},
